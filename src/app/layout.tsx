...
export const metadata: Metadata = {
  title: "VentureFund Capital - Strategic Venture Capital & Growth Investing",
  description: "Partner with experienced venture capitalists investing in SaaS, AI, fintech, and deep tech startups. Strategic capital meets operational expertise for founders building transformative companies.",
  keywords: "venture capital, startup funding, investment, founders, Series A, SaaS, fintech, AI, deep tech",
  metadataBase: new URL("https://venturefund.com"),
  alternates: {
    canonical: "https://venturefund.com"
  },
  openGraph: {
    title: "VentureFund Capital - Strategic Venture Capital & Growth Investing",
    description: "Invest in tomorrow's leaders. We provide capital, expertise, and networks to ambitious founders.",
    type: "website",
    siteName: "VentureFund Capital",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35yrpe4kav0x1CwIekFPdRxiVfn/uploaded-1764095177279-bt03yixl.jpg",
      alt: "VentureFund Capital"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "VentureFund Capital - Strategic Venture Capital",
    description: "Partner with experienced venture capitalists investing in high-growth startups.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35yrpe4kav0x1CwIekFPdRxiVfn/uploaded-1764095177279-bt03yixl.jpg"]
  }
};
